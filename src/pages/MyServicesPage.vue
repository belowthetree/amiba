          ...
          <div class="svc-actions">
            <label class="toggle">
              <input
                type="checkbox"
                :checked="svc.enabled"
                @change="toggleService(svc.manifest.id, !svc.enabled)"
              />
...
<` + `/script>
  ...
  registerService(manifest, 'ai-generated')
  storeServiceHtml(manifest.id, html)
}
</script>
